    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Complete website health check in 60 seconds</p>
          <p className="text-gray-500 mt-2">Speed • Mobile • SEO • Local Relevance • Keywords</p>
        </div>
        ...
        {!result && <AnalyzerForm onAnalyze={handleAnalyze} isLoading={isLoading} />}

        {result && (
          <>
            <div className="mb-6 text-center">
              <button onClick={handleReset} className="text-blue-600 hover:text-blue-800 underline">
