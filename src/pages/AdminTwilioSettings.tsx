    ...
    <AdminLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {/* Left Column: Configuration Details (Now full width on large screens) */}
            <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-lg border border-slate-100 space-y-6 h-fit">
                ...
                <div className="pt-4 border-t border-slate-100">
                    <h3 className="font-bold text-slate-900 mb-2 flex items-center gap-2">
                        <BookOpen className="w-4 h-4 text-indigo-600" /> Full Setup Guide
                    </h3>
                    <p className="text-sm text-slate-600">
                        For detailed instructions on purchasing a number and A2P registration, please refer to your internal documentation or contact CWP support.
                    </p>
                </div>
            </div>
            
            {/* Right Column: Empty or simplified */}
            <div className="lg:col-span-1">
                {/* This column is now free for other content or can be removed by setting lg:col-span-3 above */}
            </div>
        </div>
      </div>
    </AdminLayout>
