...
const ABACUS_API_ENDPOINT =
  import.meta.env.VITE_ABACUS_ENDPOINT || 'https://your-abacus-endpoint.com/analyze';
...
export class AbacusService {
  ...
  private static transformAbacusResponse(data: any): AnalysisResult {
    // Transform Abacus response to our AnalysisResult format
    return {
      websiteUrl: data.url,
