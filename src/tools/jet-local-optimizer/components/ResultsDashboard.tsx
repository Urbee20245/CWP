    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="mt-4 space-y-2 text-sm">
          <p>LCP (Load Speed): <strong>{result.coreWebVitals.lcp}s</strong> {result.coreWebVitals.lcp > 2.5 ? '❌' : '✅'}</p>
          <p>FID (Interactivity): <strong>{result.coreWebVitals.fid}ms</strong> {result.coreWebVitals.fid > 100 ? '❌' : '✅'}</p>
          <p>CLS (Visual Stability): <strong>{result.coreWebVitals.cls}</strong> {result.coreWebVitals.cls > 0.1 ? '❌' : '✅'}</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="mt-4 space-y-2 text-sm">
          ...
          <p>Images with Alt Tags: <strong>{result.seoStructure.altTags}</strong></p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="mt-4 space-y-2 text-sm">
          ...
          <p>Local Keywords Found: <strong>{result.localRelevance.localKeywords}</strong></p>
        </div>
      </div>

      <div className="bg-white rounded-lg shadow-lg p-6">
        <h3 className="text-xl font-bold mb-4">Keyword Gap Analysis</h3>
        <div className={`inline-block px-4 py-2 rounded-full ${getScoreBg(result.keywordGap.opportunityScore)}`}>
