-- Multi-tenant Leads ingestion system
--
-- Creates:
-- 1) public.client_lead_ingest_configs (per-client secret + controls)
-- 2) public.leads (multi-tenant storage)
--
-- SECURITY:
-- - RLS enabled on both tables
-- - No anon policies
-- - Client access restricted to client owner
-- - Admin full access
