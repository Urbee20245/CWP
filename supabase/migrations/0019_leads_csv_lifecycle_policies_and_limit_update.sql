-- Leads lifecycle controls
-- - Allow clients to delete their own leads
-- - Treat 'archived' as inactive for the 50-lead active limit
...
-- Update active lead limit trigger function
